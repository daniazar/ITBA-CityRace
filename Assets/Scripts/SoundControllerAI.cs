...
public class SoundControllerAI : MonoBehaviour {
/////////
// SoundController.js
//
...
public void  Awake (){
	car = transform.GetComponent<AICar>();
...
public void  SetVolume ( float pitch  ){
...
IEnumerable GearShift ( float oldPitchFactor ,   float newPitchFactor ,   int gear ,   bool shiftUp  ){
	 shiftingGear = true;
...
public IEnumerable  Crash ( float volumeFactor  ){
...
public IEnumerable ControlSound ( bool play ,    float fadeTime  ){
	float timer = 0;
